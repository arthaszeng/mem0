...
export function FormView({ settings, onChange }: FormViewProps) {
  ...
  const handleMemverseChange = (key: string, value: any) => {
    onChange({
      ...settings,
      memverse: {
        ...settings.memverse,
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Memverse Settings</CardTitle>
          <CardDescription>Configure your Memverse instance settings</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={settings.memverse?.custom_instructions || ""}
              onChange={(e) => handleMemverseChange("custom_instructions", e.target.value)}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 border border-zinc-800 rounded-lg space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Upload a ZIP exported by Memverse. Memories will be imported into the selected project.</p>
