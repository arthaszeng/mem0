...
This reads all points from the Qdrant collection and
...
QDRANT_HOST = os.getenv("QDRANT_HOST", "memverse_store")
...
def main():
    ...
    for pt in all_points:
        try:
            ...
            app_name = payload.get("mcp_client") or payload.get("source_app") or "memverse"
